...
AGENT_KB = {
    "Framer": {
        ...
        "guardrails": [
            ...
            "Do NOT create PRDs — route PRD requests to Executor (only after problem is framed)",
    ...
    "Executor": {
        ...
        "core_job": "Convert decisions into executable plans, MVP scope, launch steps, PRDs, and user stories",
        "primary_inputs": [
            "MVP scope requests",
            "Launch plans",
            "Checklists",
            ...
            "Blockers",
            "Deployment plans",
            "PRD requests (when problem is framed and decision is made)",
            "User story creation requests",
        ...
        "input_schema": {
            ...
            "document_type": "optional: prd | user_stories | both",
        },
        "output_schema": {
            "status": "complete | needs_clarification",
            "mvp_scope": "in-scope vs out-of-scope",
            "execution_plan": "step-by-step plan",
            "prd": "product requirements document (when requested)",
            "user_stories": "list of user stories with acceptance criteria (when requested)",
        ...
        "guardrails": [
            ...
            "Do NOT write PRDs for unframed problems — route to Framer first",
            "Do NOT create user stories without a clear decided scope",
            "PRDs must reference the decided strategy and framed problem",
        ...
        "anti_patterns": [
            ...
            "Writing PRDs as a substitute for decision-making",
            "Creating user stories for undefined or unvalidated features",
            "PRDs without success metrics or guardrail metrics",
        ],
        "clarification_triggers": [
            ...
            "PRD requested but problem not yet framed (route to Framer)",
            "User stories requested but scope not yet defined",
        ],
    },
    "Aligner": {
